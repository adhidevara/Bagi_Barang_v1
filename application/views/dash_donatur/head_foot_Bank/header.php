    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#">BANK - BAGI BARANG</a>
            </div>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li class="active">
                        <a href="<?php echo base_url() ?>donatur/C_Bank/virtualAccount">
                    ...
                    <li>
                        <a href="<?php echo base_url() ?>donatur/C_Bank/transfer">
                    ...
                    <li>
                        <a href="<?php echo base_url() ?>donatur/C_Bank/accTransfer">
