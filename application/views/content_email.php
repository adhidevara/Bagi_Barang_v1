...
<link href="https://fonts.googleapis.com/css?family=Lato" rel="stylesheet" type="text/css"> <!--##custom-font-resource##-->
...
td[class="pattern"] .c244p42r { width: 42.857142857142875%;}
td[class="pattern"] .c325p57r { width: 57.14285714285712%;}
td[class="pattern"] .c108p33n { width: 33.33333333333334%;}
td[class="pattern"] .c183p33r { width: 33.333333333333336%;}
...
only screen and (max-device-width: 400px) {
 ...
 .hide { display:none !important; width:0px !important;height:0px !important; overflow:hidden; }
    .c244p42r { width: 100% !important; float:none;}
.c325p57r { width: 100% !important; float:none;}
.c108p33n { width: 33.33333333333334% !important;}
...
@media only screen and (min-width: 600px) {
  td[class="pattern"] .c244p42r { width: 244px !important;}
td[class="pattern"] .c325p57r { width: 325px !important;}
td[class="pattern"] .c108p33n { width: 33.33333333333334% !important;}
...
only screen and (max-device-width: 400px) {
  ...
  td[class="pattern"] .c244p42r { width: 100% !important; }
td[class="pattern"] .c325p57r { width: 100% !important; }
td[class="pattern"] .c108p33n { width: 33.33333333333334% !important; }
td[class="pattern"] .c183p33r { width: 100% !important; }

}
@media screen and (-webkit-min-device-pixel-ratio:0) {
  .img36x36 { width: 36px !important; height: 36px !important;}
...
<body leftmargin="0" marginwidth="0" topmargin="0" marginheight="0" offset="0" style="font-family:Arial, sans-serif; font-size:0px;margin:0;padding:0;background: #FF9004 !important;" bgcolor="#FF9004">
<span style='display:none;font-size:0px;line-height:0px;max-height:0px;max-width:0px;opacity:0;overflow:hidden'>email_verif</span>
<style>
...
<!--[if t]><![endif]--><!--[if t]><![endif]--><!--[if t]><![endif]--><!--[if t]><![endif]--><!--[if t]><![endif]--><!--[if t]><![endif]-->
  <table align="center" border="0" cellpadding="0" cellspacing="0" height="100%" width="100%"  bgcolor="#FF9004" style="margin:0; padding:0; width:100% !important; background: #FF9004 !important;">
    <tr>
...
<td valign="top" style="padding-top:10px;padding-right:15px;padding-left:15px">
...
<table cellpadding="0" cellspacing="0" border="0" align="left" width="244" id="c244p42r"  style="float:left" class="c244p42r">
<tr>
<td valign="top"  style="padding:0px">
<table cellpadding="0" cellspacing="0" border="0" width="100%">
<tr>
...
<table cellpadding="0" cellspacing="0" border="0" align="left" width="325" id="c325p57r"  style="float:left" class="c325p57r">
<tr>
<td valign="top"  style="padding:0px">
<table cellpadding="0" cellspacing="0" border="0" width="100%" style="border:0px none">
<tr>
...
<table cellpadding="0" cellspacing="0" border="0" width="100%">
<tr>
<td valign="top" width="108"  style="padding:0px" class="c108p33n">
<table cellpadding="0" cellspacing="0" border="0" width="100%">
<tr>

<td valign="top" align="center" style="padding:10px">
<table cellpadding="0" cellspacing="0" border="0" width="36" style="border:0px none">
<tr>

<td valign="top" style="padding:0px"><img 
src="https://images.chamaileon.io/5af430d4a0870300120192f8/1460562865_06-facebook_2019-03-10P18.20.35.469.png" width="36" height="36" alt="" border="0"  style="display:block" class="img36x36"  />
</td>
</tr>
</table>
...
<td valign="top" style="padding:0px"><img 
src="https://images.chamaileon.io/5af430d4a0870300120192f8/1460562885_03-twitter_2019-03-10P18.20.35.063.png" width="36" height="36" alt="" border="0"  style="display:block" class="img36x36"  />
</td>
</tr>
</table>
...
<td valign="top" style="padding:0px"><img 
src="https://images.chamaileon.io/5af430d4a0870300120192f8/1460563162_38-instagram_2019-03-10P18.20.35.083.png" width="36" height="36" alt="" border="0"  style="display:block" class="img36x36"  />
</td>
</tr>
</table>
...
<table cellpadding="0" cellspacing="0" border="0" width="100%">
<tr>
<td valign="top"  style="padding:10px"><div  style="text-align:left;font-family:Arial;font-size:16px;color:#000000;line-height:22px;mso-line-height:exactly;mso-text-raise:3px"><h2 style="font-family:Lato, Helvetica Neue, Helvetica, Arial, sans-serif; font-size: 28px; color: #404040; line-height: 42px; mso-line-height: exactly; mso-text-raise: 7px; padding: 0; margin: 0;text-align: center;"><span class="mso-font-fix-arial"><strong>BAGI BARANG</strong></span></h2><p style="padding: 0; margin: 0;text-align: center;">_________________________________________________________</p><h1
style="font-family:Lato, Helvetica Neue, Helvetica, Arial, sans-serif; font-size: 40px; color: #F2552C; line-height: 56px; mso-line-height: exactly; mso-text-raise: 8px; padding: 0; margin: 0;text-align: center;"><span class="mso-font-fix-arial"><strong>VERIFIKASI AKUN</strong></span></h1></div></td>
</tr>
</table>
...
<tr>
<td valign="top"  style="padding:0;mso-cellspacing:0in">
<table cellpadding="0" cellspacing="0" border="0" align="left" width="183" id="c183p33r"  style="float:left" class="c183p33r">
<tr>
<td valign="top"  style="padding:0px">
<table cellpadding="0" cellspacing="0" border="0" width="100%">
<tr>
...
<table cellpadding="0" cellspacing="0" border="0" width="100%">
<tr>
<td valign="top"  style="padding:10px"><div  style="text-align:left;font-family:Arial;font-size:16px;color:#000000;line-height:22px;mso-line-height:exactly;mso-text-raise:3px"><h3 style="font-family:Arial; font-size: 20px; color: #000000; line-height: 30px; mso-line-height: exactly; mso-text-raise: 5px; padding: 0; margin: 0;text-align: center;"><b>Hai, <?= $nama; ?></b></h3></div></td>
</tr>
</table>
...
<table cellpadding="0" cellspacing="0" border="0" bgcolor="#F2552C" style="border:0px none;border-radius:5px;border-collapse:separate !important;background-color:#F2552C">
<tr>
...
<table cellpadding="0" cellspacing="0" border="0" width="100%">
<tr>
<td valign="top"  style="padding:10px"><div  style="text-align:left;font-family:Arial;font-size:16px;color:#000000;line-height:22px;mso-line-height:exactly;mso-text-raise:3px"><p style="padding: 0; margin: 0;text-align: center;">Terima kasih telah melakukan pendaftaran akun sebagai <?= $jenis_akun; ?>. Untuk dapat melanjutkan aktivitas di website kami silahkan klik tombol diatas untuk aktivasi akun anda<br><br>Kami segenap Tim Bagi Barang akan melayani niat baik anda untuk berdonasi kepada orang-orang yang membutuhkan</p></div></td>
</tr>
</table>
...
<table cellpadding="0" cellspacing="0" border="0" width="100%">
<tr>
<td valign="top"  style="padding:10px"><div  style="text-align:left;font-family:Arial;font-size:16px;color:#000000;line-height:22px;mso-line-height:exactly;mso-text-raise:3px"><p style="padding: 0; margin: 0;text-align: center;">©2019 BAGI BARANG,</p></div></td>
</tr>
</table>
</td>
</tr>
