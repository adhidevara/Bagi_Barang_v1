    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">BAGI BARANG - DASHBOARD PENGELOLA</a>
            </div>
            ...
            <div class="user-info">
                <div class="image">
                    <?php if ($this->session->userdata('foto') == ""){ ?>
                        <img src="<?= base_url(); ?>assets/dashAssets/images/user.png" width="48" height="48" alt="User" />
                    <?php } else { ?>
                        <img src="<?= base_url().$this->session->userdata('foto'); ?>" width="48" height="48" alt="User" />
                    <?php } ?>
                </div>
