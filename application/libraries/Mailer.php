...
class Mailer {
    protected $_ci;
    protected $email_pengirim = 'bagi.bagibarang@gmail.com'; // Isikan dengan email pengirim
    protected $nama_pengirim = 'CS BagiBarang'; // Isikan dengan nama pengirim
    protected $password = 'bagibagibarang123'; // Isikan dengan password email pengirim bfwvsqyrimrnucvl
